...
function cart()
{
    ...
    if (isset($_GET['add_cart'])) {
        ...
        if (mysqli_num_rows($run_check) > 0) {
            ...
            echo "<script>window.open('productResp.php','_self')</script>";
        }
...
function getCats()
{
    ...
    while ($row_cats = mysqli_fetch_array($run_cats)) {
     ...
     <li class='fur__item nav__item categories__item'>
         <a class='categories__link fur__link nav__link' 
             href='productResp.php?cat=$cat_id'>$cat_title
         </a>
      </li>";
...
function getBrands()
{
    ...
    while ($row_brands = mysqli_fetch_array($run_brands)) {
        ...
        echo "<li class='nav__item brands__item'><a class='nav__link brands__link' href='productResp.php?brand=$brand_id'>$brand_title</a></li>";
...
function getShops()
{
    ...
    while ($row_shops = mysqli_fetch_array($run_shops)) {
        ...
        echo "<li class='nav__item shops__item'>
        <a class='nav__link shops__link' href='productResp.php?shop=$shop_id'>$shop_title
        </a>
 </li>";
