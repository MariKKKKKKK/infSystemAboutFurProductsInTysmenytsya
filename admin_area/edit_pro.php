...
if(isset($_GET['edit_pro'])){
	...
	$row_pro=mysqli_fetch_array($run_pro);
		...
		$pro_bg_image =$row_pro['product_bg_image'];
		...
		$get_shop = "select * from shop where shop_id='$pro_shop'";
...
<body bgcolor="skyblue">
	...
	echo "<option value='$brand_id'>$brand_title</option>";
			...
			<tr>
				...
				<td>
					<select name="product_shop" >
						<option><?php echo $shop_title; ?></option>
						<?php
			...
			<tr align="center">
				<td colspan="7"><input type="submit" name="update_product" value="оновити інформацію про товар"/></td>
			</tr>
...
<?php 
    ...
    product_shop='$product_shop', product_title='$product_title',product_price='$product_price',product_desc='$product_desc',
    product_image='$product_image',  product_bg_image='$product_bg_image',
